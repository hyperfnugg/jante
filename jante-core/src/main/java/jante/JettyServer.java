...
import static jante.util.ExceptionUtil.wrapCheckedExceptionsVoid;
...
public final class JettyServer {
    ...
    public Runtime start(JerseyConfig jerseyConfig) {
        ...
        ExceptionUtil.wrapCheckedExceptionsVoid(server::start);
    ...
    public static class Runtime {
        ...
        public Runtime join() {
            ExceptionUtil.wrapCheckedExceptionsVoid(server::join);
            return this;
        }

        public Runtime stop() {
            ExceptionUtil.wrapCheckedExceptionsVoid(server::stop);
            return this;
        }
